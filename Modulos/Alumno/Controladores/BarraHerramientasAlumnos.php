...
/**
 * Description of BarraHerramientasAlumnos
 *
 * @author WERD
 */
class BarraHerramientasAlumnos
{
    protected $_bh;
    protected $_id;
    protected $_bt;
    ...
    public function getBarraHerramientasEditar($id=null)
    {
        ...
        $this->_bh->addBoton('Volver', $this->_bt->getParamBotonVolver());
        $this->_bh->addBoton('Nuevo', $this->_bt->getParamBotonNuevo());
        $this->_bh->addBoton('Imprimir', $this->_bt->getParamBotonImprimirFicha());
