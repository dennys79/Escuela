<div class="col-md-5 ui-corner-all">
    <form id="nueva_foto" 
          ...
          method="post" 
          action="?mod=Alumno&cont=foto&met=nuevo&id=<?php if ($this->datos->getId()) echo $this->datos->getId(); ?>">
        ...
        <div class="form-group">
            ...
            <?php }else { ?>
                <div class="col-xs-6 col-md-3">
                    <input type="image" name="mostrarFoto" id="mostrarFoto" src="Public/Img/Fotos/Alumno/Idsin_imagen.png" 
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="file" class="input" name="foto" id="foto" class="form-control"
                           data-url="?option=Alumno&sub=index&met=editar&id=<?php if ($this->datos->getId()) echo $this->datos->getId(); ?>">
                </div>
            </div>
