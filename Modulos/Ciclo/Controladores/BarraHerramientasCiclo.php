...
/**
 * Description of BarraHerramientasCiclos
 *
 * @author WERD
 */
class BarraHerramientasCiclo
{
    protected $_bh;
    protected $_id;
    protected $_bt;
    ...
    public function getBarraHerramientasIndex()
    {
        ...
        $this->_bh->addBoton('Editar', $this->_bt->getParamBotonEditar());
        $this->_bh->addBoton('Eliminar', $this->_bt->getParamBotonEliminar());
        $this->_bh->addBoton('Actual', $this->_bt->getParamBotonSetCicloActual());
