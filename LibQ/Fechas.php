...
class LibQ_Fecha extends DateTime {
    ...
    /**
     * Class constructor
     * @param String $fecha con la fecha que se quiere crear si no se envía entonces se crea la fecha actual
     * @param String $zone, la zona horaria
     */
...
//        echo $dia_dif . '-' . $mes_dif;
    ...
    /**
     * Funcion Static que devuelve una fecha en formmato para BD
     * @param string $fecha
     * @return LibQ_Fecha
     */
