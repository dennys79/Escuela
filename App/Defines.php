...
/**
 * Path de la carpeta donde estan las imágenes públicas
 */
define('IMG_PUBLIC_PATH', 'Public'.DS.'Img'.DS);
/**
 * Path de la carpeta donde estan las fotos públicas
 */
define('FOTOS_PUBLIC_PATH', IMG_PUBLIC_PATH . 'Fotos' . DS);
