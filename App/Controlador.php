...
abstract class App_Controlador {
    ...
    /**
     * Variable que registra los eventos del usuario
     * @var App_Registro
     */
    protected $_registro;
    ...
    public function __construct() {
        ...
        $this->_cargarVista();
        $this->_registro = new App_Registro();
    ...
    /**
     * Obtiene un parametro del Get sin filtrar
     * @param string $clave
     * @return mixed 
     */
    protected function getGetParam($clave) {
        return filter_input(INPUT_GET, $clave);
    }
